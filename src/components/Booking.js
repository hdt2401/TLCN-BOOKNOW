        ...
        <div className="col-md-4">
          <div className="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Tuyến xe đi từ: </p>
              <p class="card-text">Tuyến xe dừng tại:</p>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Thời gian khởi hành</li>
              <li class="list-group-item">Thời gian đến</li>
            </ul>
            <div class="card-body">
              <p>Giá tiền:</p>
            </div>
